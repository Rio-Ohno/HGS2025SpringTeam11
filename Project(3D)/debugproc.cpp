...
// グローバル変数
//==========================================================
LPD3DXFONT g_pFont2 = nullptr;	//フォントへのポインタ
...
// デバッグONOFF表示メッセージ
//==========================================================
const char *c_apOnOff[static_cast<int>(TYPE::DEBUGTYPE_MAX)] =
{
	"OFF",
	"ON",
};
...
void InitDebugProc(void)
{
	...
	//デバッグ表示用フォントの生成
	D3DXCreateFont(pDevice, 30, 0, 0, 0, FALSE, HANGUL_CHARSET, OUT_DEFAULT_PRECIS, DEFAULT_QUALITY, DEFAULT_PITCH, "Terminal", &g_pFont2);
...
void DrawDebugProc(void)
{
	...
	{//デバックモードがオンの時
	 //テキストの描画
		g_pFont2->DrawText(nullptr, &g_aStrDebug[0], -1, &rect, DT_LEFT, D3DCOLOR_RGBA(255, 255, 255, 255));
	}
